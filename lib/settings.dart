...
class AppSettings {
  /// Basic Settings
  static const String applicationName = 'marche_td';
  static const String andoidPackageName = 'com.tasolutions.marche_td';
  static const String shareAppText = "Share this App";

  static const String hostUrl =
      "PLACE_YOUR_ADMIN_PANEL_HOST_URL_HERE"; // DON'T ADD / AT END
